...
export const Statistics: React.FC = () => {
  ...
  const {loading, statistics} = hooks.useGetStatistics();
        ...
        <div>
          ...
          <section>
            ...
            >
              <img
                src={
                  'https://george-fx.github.io/apitex_api/assets/cards/01.png'
                }
                alt='card'
          ...
          <section>
            <ul>
              {statistics.map((item, index, array) => {
                ...
                return (
                  <Link
                    ...
                    href={Routes.TRANSACTION_DETAILS}
                  >
                    {/* {item.icon} */}
                    <Image
                      src={item.icon}
